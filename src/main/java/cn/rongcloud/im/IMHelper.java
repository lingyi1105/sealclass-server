...
public class IMHelper {
     ...
     * @return TokenResult
     **/
    public IMTokenInfo getToken(String appkey, String secret, String userId, String name, String portraitUri) throws Exception {
        if (userId == null) {
        ...
        HttpURLConnection conn = httpHelper.createIMPostHttpConnection(appkey, secret, "/user/getToken.json", "application/x-www-form-urlencoded");
     ...
     **/
    public IMApiResultInfo createGroup(String appkey, String secret, String[] userId, String groupId, String groupName)
            throws Exception {
        if (userId == null) {
            throw new IllegalArgumentException("Paramer 'userId' is required");
        }
        ...
        HttpURLConnection conn = httpHelper
                .createIMPostHttpConnection(appkey, secret, "/group/create.json", "application/x-www-form-urlencoded");
        httpHelper.setBodyParameter(body, conn);
     ...
     * @return CodeSuccessResult
     **/
    public IMApiResultInfo joinGroup(String appkey, String secret, String[] userId, String groupId, String groupName)
            throws Exception {
        if (userId == null) {
            throw new IllegalArgumentException("Paramer 'userId' is required");
        }
        ...
        HttpURLConnection conn = httpHelper
                .createIMPostHttpConnection(appkey, secret, "/group/join.json", "application/x-www-form-urlencoded");
        httpHelper.setBodyParameter(body, conn);
     ...
     * @return CodeSuccessResult
     **/
    public IMApiResultInfo quit(String appkey, String secret, String[] userId, String groupId) throws Exception {
        if (userId == null) {
            throw new IllegalArgumentException("Paramer 'userId' is required");
        }
        ...
        HttpURLConnection conn = httpHelper
                .createIMPostHttpConnection(appkey, secret, "/group/quit.json", "application/x-www-form-urlencoded");
        httpHelper.setBodyParameter(body, conn);
     ...
     * @return CodeSuccessResult
     **/
    public IMApiResultInfo dismiss(String appkey, String secret, String userId, String groupId) throws Exception {
        if (userId == null) {
            throw new IllegalArgumentException("Paramer 'userId' is required");
        }
        ...
        HttpURLConnection conn = httpHelper
                .createIMPostHttpConnection(appkey, secret, "/group/dismiss.json", "application/x-www-form-urlencoded");
        httpHelper.setBodyParameter(body, conn);
...
//     * @return CodeSuccessResult
//     **/
    public IMApiResultInfo publishMessage(String appkey, String secret, String fromUserId, String toGroupId, BaseMessage message) throws Exception {
        String[] toGroupIds = new String[1];
        toGroupIds[0] = toGroupId;
        return publishMessage(appkey, secret, fromUserId, null, toGroupIds, message, "", "", 0,
                0, 0, 0, 0);
    }

    public IMApiResultInfo publishMessage(String appkey, String secret, String fromUserId, String toGroupId, BaseMessage message, Integer isIncludeSender) throws Exception {
        String[] toGroupIds = new String[1];
        toGroupIds[0] = toGroupId;
        return publishMessage(appkey, secret, fromUserId, null, toGroupIds, message, "", "", 0,
    ...
    public IMApiResultInfo publishMessage(String appkey, String secret, String fromUserId, String toUserId, String toGroupId, BaseMessage message) throws Exception {
        String[] toGroupIds = new String[1];
        toGroupIds[0] = toGroupId;
        return publishMessage(appkey, secret, fromUserId, toUserId, toGroupIds, message, "", "", 0,
                0, 0, 0, 0);
    }

    public IMApiResultInfo publishMessage(String appkey, String secret, String fromUserId, String toUserId, String[] toGroupId,
        ...
        HttpURLConnection conn = httpHelper
                .createIMPostHttpConnection(appkey, secret, url, "application/x-www-form-urlencoded");
        httpHelper.setBodyParameter(body, conn);

        return JSON.parseObject(httpHelper.returnResult(conn, body), IMApiResultInfo.class);
    }

    public IMApiResultInfo publishPrivateMessage(String appkey, String secret, String fromUserId, String toUserId, BaseMessage message) throws Exception {
        return publishPrivateMessage(appkey, secret, fromUserId, toUserId, message, "", "", 0, 0, 0, 0, 0);
    }

    public IMApiResultInfo publishPrivateMessage(String appkey, String secret, String fromUserId, String toUserId,
                                          BaseMessage message, String pushContent, String pushData, Integer isPersisted,
                                          Integer isCounted, Integer isIncludeSender, Integer isStatus, Integer isMentioned)
            throws Exception {
        if (fromUserId == null) {
